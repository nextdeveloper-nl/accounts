...
trait UserTestTraits
{
    ...
    */
    ...
    {
        $this->setupGuzzle();
        $response = $this->http->request('GET', '/account/user');
    ...
    */
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserRetrievedEvent() );
        } catch (\Exception $e) {
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserCreatedEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserCreatingEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserSavingEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserSavedEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserUpdatingEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserUpdatedEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserDeletingEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserDeletedEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserRestoringEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            event( new \NextDeveloper\Account\Events\User\UserRestoredEvent() );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    {
        try {
            $model = \NextDeveloper\Account\Database\Models\User::first();

            event( new \NextDeveloper\Account\Events\User\UserRetrievedEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_created_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserCreatedEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_creating_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserCreatingEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_saving_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserSavingEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_saved_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserSavedEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_updating_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserUpdatingEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_updated_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserUpdatedEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_deleting_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserDeletingEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_deleted_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserDeletedEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_restoring_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserRestoringEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_restored_with_object()
    {
        try {
            ...
            event( new \NextDeveloper\Account\Events\User\UserRestoredEvent($model) );
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
    ...
    public function test_user_event_name_filter()
    {
        try {
            ...
            $model = \NextDeveloper\Account\Database\Models\User::filter($filter)->first();
        } catch (\Exception $e) {
            $this->assertFalse(false, $e->getMessage());
        }
