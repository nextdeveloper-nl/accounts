...
class AbstractAccountTypeService {
    public static function get(AccountTypeQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator {
        ...
        */
        if($filter == null)
            $filter = new AccountTypeQueryFilter(new Request());
        ...
        $model = AccountType::filter($filter);
        ...
        if(!$model && $enablePaginate)
            return AccountType::paginate($perPage);
        else
    ...
    * @return mixed
    */
    public static function getByRef($ref) : ?AccountType {
        return AccountType::findByRef($ref);
    }
    ...
    */
    public static function getById($id) : ?AccountType {
        return AccountType::where('id', $id)->first();
    }
    ...
    */
    public static function create(array $data) {
        ...
        event( new AccountTypeCreatedEvent($model) );
