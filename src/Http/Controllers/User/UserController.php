...
namespace NextDeveloper\Account\Http\Controllers\User;

use Illuminate\Http\Request;
use NextDeveloper\Generator\Common\AbstractController;
use NextDeveloper\Generator\Http\Traits\ResponsableFactory;
use NextDeveloper\Account\Database\Filters\UserQueryFilter;
use NextDeveloper\Account\Http\Transformers\UserTransformer;
use NextDeveloper\Account\Services\UserService;
use NextDeveloper\Account\Http\Requests\User\UserCreateRequest;
