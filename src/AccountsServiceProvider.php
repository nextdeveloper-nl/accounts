...
namespace NextDeveloper\Accounts;
 ...
 *
 * @package NextDeveloper\Accounts
 */
class AccountsServiceProvider extends AbstractServiceProvider {
    /**
     * @var bool
     */
    ...
    public function boot() {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'Accounts');
...
//    }
    ...
    protected function registerRoutes() {
        if ( ! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\Accounts\Http\Controllers')
