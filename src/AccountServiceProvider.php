...
namespace NextDeveloper\Account;
...
class AccountServiceProvider extends AbstractServiceProvider {
    ...
    public function boot() {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'Account');
...
//    }
    ...
    protected function registerRoutes() {
        if ( ! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\Account\Http\Controllers')
